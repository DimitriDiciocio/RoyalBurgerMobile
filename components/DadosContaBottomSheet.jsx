...
export default function DadosContaBottomSheet({ visible, onClose, userData }) {
  const handleEditName = () => {
    console.log('Editar nome');
  };

  const handleEditCPF = () => {
    console.log('Editar CPF');
  };
    ...
    <BottomSheet visible={visible} onClose={onClose} heightPercentage={0.75}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <BotaoCheck
            title="Nome Completo"
            description={userData?.full_name || userData?.name || 'Nome não informado.'}
            iconSvg={penSvg}
          ...
          <BotaoCheck
            ...
            description={userData?.date_of_birth || 'Data de nascimento não informada.'}
            iconSvg={penSvg}
